...
(11, '6. Qual das opções abaixo “were there” ou “there were” contém a mesma função que em “were there any kids in there?” ', 'a) Jack and Bob were there too.', 'B) Bob and Josh was empty','c) Boy, were there lots of snakes back then.', 'd) There were no chairs at all.','4', 2),
(12, '1. Na pergunta “What fish did you see?”, podemos afirmar que:', 'a)  O correto seria “what fish you saw?”', 'b)  Não há qualquer erro gramatical;', 'c) Está incorreta, pois o verbo auxiliar did deveria estar no começo da pergunta.','d) Uma possível resposta seria “I saw two fishes”.', '2', 3),
(13, '2. Qual frase abaixo é vista como correta ante os ditames gramaticais da língua inglesa?','a) I did a research.','b) I bought one clothe.','c) I bought two equipment.','d) I would rather you went tomorrow.', '4', 3),
(14, '3. Qual alternativa abaixo apresenta uma frase passível de polêmica em função da sua construção?','a) I like reading books.','b) I’ve been meaning to tell you something.','c) That’s a song I’ve never heard of.','d) no one previus awnser', '3', 3),
(15, '4.  Complete a frase ” I can’t help____________”', 'a) eat chocolate;','b) eating chocolate;','c) for eating chocolate;','d) eaten chocolate','2', 3),
(16, '5. “Can’t get enough of it” indica:','a) Falta de paciência;','b) Predileção;','c) Cansaço;','d) Tristeza;','2', 3),
(17, '6. Qual frase abaixo contém a mesma função de yet presente na frase “My brother is 100% right and yet 100% wrong”?','a) It is yet to come.','b) Are we there yet?','c) The Zika virus doesn’t yet pose a threat to people in the United States.','d) I am trying to keep drugs out of my life, and yet I’m forced to take them every day.','4', 3),
(18, '7. Qual o sentido da composição fancy myself na frase “I fancied myself living in a place like this”?', 'a) me vi','b) me permiti','c) me policiei','d) me dei o direito', '1', 3),
(19, '8. Complete a frase: “this car _________fourteen thousand dollars”. ','a) affords','b) goes for','c) coasted','d) value', '2', 3),
(20, '9. O que significa drive home na frase “The newspapers drive home the fact that violence is part of urban life“?', 'a) dar o recado','b) dirigir para casa', 'c) revelar', 'd) abordar', 1, 3),
(21, "10. I wouldn’t’ve looked so long for the misplaced book had I known it was in your backpack all along!", "a) There are no errors in being pointed out.", "(b) The contraction would not be inadmissible.", "c) A contração wouldn’t’ve é inadmissível bem como had I known. Deve-se rescrever I had known.", "d) A contração wouldn’t’ve é inadmissível bem como had I known. Deve-se rescrever If I had known.", '1', 3),
(22, "11. Jack: Could you give me a hand with this? Bob: Sure, I’ll help you do the dishes.", "a) The verb that comes after the help must be in the infinitive.", "b) The verb after help should include the sequence of letters 'ing'.", "c) There are no errors to be pointed out.", "d) O demonstrativo adequado para o contexto em questão é that e não this.", '3', 3),
(23, "12. I then did a research and learned that Rio de Janeiro is not the capital of Brazil.", "a) The correct is researched, without the use of indefinite article.", "b) There are no errors to be pointed out.", "c) The correct one is Brazil’s capital and not capital of Brazil.", "d) For the context in question, correct is than and not then.", '1', 3),
(24, "13. Indicate an alternative that expresses the same meaning as: When children watch TV, they find a wide variety of places, people, and information.", "a) When children watch TV, a wide range of places, people, and information will be encounter", "b) When children watch TV, a wide range of places, people, and information are encountered", "c) When children watch TV, a wide range of places, people, and information is encountered.", "d) When TV was watched, a wide range of places, people, and information are encountered by children.", '1', 3),
...
(29, "10. Mark the incorrect sentence.", "a)The person who phoned me last night is my teacher.", "b)The car which hit me was red.", "c)The student whose phone just rang should stand up.", "d)The police are looking for the car which driver was masked.", '4', 1), 
 (30, "11. (UFSCar) Go and find the driver ________ arrived here yesterday.", "a) he", "b) who", "c) whose", "d) what", '2', 1),
(31, "12. (FMU – SP) He is the man ____________ sings very well", "a) whom", "b) how","c) which","d) whoe) ", '4', 1),
(32, "13. That’s the fireman _________ son suffered an accident this afternoon.", "a) which", "b) who", "c) whose", "d) whom",  '3', 1),
(33, "14. Mark the option that complete correctly the sentences: 1 - The car, __________ was a taxi, exploded. 2 - Mrs Jack, __________ I like very much, is my teacher.  3-My brother, __________ phone you just heard, is a doctor.", "a) which,whom,whose.", "b) which, who, who.","c) that, who, who.","d) which, that, which.", '1', 1),
...
(37, "15. (Mackenzie SP) The word “masterpiece” is wrongly used in:", "a) One day I’ll paint a masterpiece." ,"b) This is one of the great masterpieces of European art." , "c) The masterpiece of the expedition was a Frenchman.", "d) It was a masterpiece of deceit.", '3', 3);
