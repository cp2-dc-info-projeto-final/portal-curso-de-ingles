...
(25, "Mary: I am about to fall asleep. I need to wake up! Clare: I______you some coffee.","a) 'll go", "b) am going to get", "c) will get", "d) am going to get to", '3', 1),
(26, "  Billy: After you _____work, will you please drop by the grocery store and pick up some milk and bread. Sally: No problem, I ____up the groceries and be home by 6 o'clock", "a) left – will not pick", "b) leaves – will pick", "c) left – won't pick", "d) leave – will pick", '4', 1),
