...
INSERT INTO `questao`(`idquestao`, `enunciado`, `opA`, `opB`, `opC`, `opD`, `gabarito`, `tipo`) 
VALUES
(20, ' What does drive home mean in the sentence "The newspapers drive home the fact that violence is part of urban life"?', ' give the message',' drive home', ' to reveal', ' approach', 1, 3),
(21, " I wouldn't've looked so long for the misplaced book had I known it was in your backpack all along!", " There are no errors in being pointed out.", " The contraction would not be inadmissible.", " The contraction wouldn't've is inadmissible, as well as 'had I known'. It must be rewrited as 'I had known'.", "The contraction wouldn't've is inadmissible, as well as 'had I known'. It must be rewrited as 'If I had known'.", '1', 3),
...
(40, "In ''The cubs were in good health and receiving round-the-clock care ...'' the expression''round-the-clock'' is equivalent to ", "every half hour", "every six hours", "every fifteen minutes", "all the time", '4', '2'),
